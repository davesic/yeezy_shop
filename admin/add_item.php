        ...
        <div class="row wish_empty">
            <div class="col-lg-12">
                <center>
                    ...
                    <?php $add_product = add_product($_POST['name'], (int)$_POST['price'],  $_POST['category'], $_POST['link'], htmlspecialchars($_POST['description'])); ?>
                    ...
                    <div class="form-outline">
                        <textarea class="form-control" id="textAreaExample"  placeholder="Описание товара" method="post" name="description"></textarea>
                    </div>
                    <br>
                    <div class="form-outline">
                    
                   
                    <input class="btn btn-primary mb-2" type="submit" value="Добавить">
                    </div>
                    </form>
                </center>
            </div>
